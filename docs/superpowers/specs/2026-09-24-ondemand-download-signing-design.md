...
#### 变异验证（m17–m22，6 条，跑完均已还原，`grep -c MUTATION py/{auth,database,main}.py` 全为 0）
...
- `py/tests/test_scrape_dn_history_migration.py`：**8 passed**
- 两文件合计：**92 passed**
- 全量：**876 passed / 0 failed**（254.65s）
